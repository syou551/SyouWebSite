...
export { DeflateDecoder, DeflateEncoder, GzDecoder, GzEncoder, ZlibDecoder, ZlibEncoder, init as default, deflate, gunzip, gzip, inflate, init, initSync, unzlib, zlib };
//# sourceMappingURL=foras.mjs.map
