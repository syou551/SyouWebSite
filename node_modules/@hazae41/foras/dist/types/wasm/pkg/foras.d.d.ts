...
export { DeflateDecoder, DeflateEncoder, GzDecoder, GzEncoder, InitInput, InitOutput, SyncInitInput, ZlibDecoder, ZlibEncoder, deflate, gunzip, gzip, inflate, init, initSync, unzlib, zlib };
